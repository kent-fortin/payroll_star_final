...
<div class="col-md-3"><div class="card stat-card bg-dark text-white p-4"><div class="small">Menunggu Persetujuan</div><div class="metric-number"><?= $countPending ?></div></div></div>
</div>
<div class="row g-4">
<div class="col-lg-8"><div class="card content-card shadow-sm p-4"><h2 class="h4 mb-3">Akses Menu</h2>
<div class="row g-3">
<div class="col-md-6"><a class="btn btn-outline-primary w-100 py-3" href="<?= url('approval/absensi.php') ?>">Persetujuan Edit Absensi</a></div>
<div class="col-md-6"><a class="btn btn-outline-primary w-100 py-3" href="<?= url('laporan/laporan.php') ?>">Lihat Laporan Gaji</a></div>
</div></div></div>
