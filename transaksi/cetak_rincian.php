...
<div class="row mb-4"><div class="col-6"><strong>NIP</strong>: <?= e($row['nip']) ?><br><strong>Nama</strong>: <?= e($row['nama_karyawan']) ?><br><strong>Jabatan</strong>: <?= e($row['nama_jabatan']) ?></div><div class="col-6 text-end"><strong>Status</strong>: <?= e($row['status_pembayaran']) ?><br><strong>Tanggal Bayar</strong>: <?= e($row['tanggal_pembayaran']??'-') ?></div></div>
<table class="table table-bordered"><tr><th>Komponen</th><th>Jumlah</th></tr><tr><td>Gaji Pokok</td><td><?= rupiah($row['gaji_pokok']) ?></td></tr><tr><td>Lembur</td><td><?= rupiah($row['total_lembur']) ?></td></tr><tr><td>Tunjangan</td><td><?= rupiah($row['total_tunjangan'] ?? 0) ?></td></tr><tr><td>Potongan Alpha</td><td>− <?= rupiah($row['total_potongan_alpha']) ?></td></tr><tr class="table-primary"><th>Total Gaji Bersih</th><th><?= rupiah($row['total_gaji_bersih']) ?></th></tr></table>
<div class="row text-center mt-5"><div class="col-6"><p>Mengetahui,</p><div style="height:70px"></div><strong>Pimpinan</strong></div><div class="col-6"><p>Admin Payroll,</p><div style="height:70px"></div><strong>Administrator</strong></div></div></div></div></body></html>
